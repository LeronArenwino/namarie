...
import co.com.leronarenwino.propertiesmanager.PropertiesManager;
import co.com.leronarenwino.jukeboxcontroller.JukeboxController;
...
import static co.com.leronarenwino.setting.SettingsSingleton.*;
import static co.com.leronarenwino.jukeboxcontroller.JukeboxController.*;
...
public class MainWindow extends javax.swing.JFrame implements Serializable {
    ...
    public MainWindow() throws NoSuchAlgorithmException {
        ...
        setSettingsFromProperties(PropertiesManager.loadProperties());
