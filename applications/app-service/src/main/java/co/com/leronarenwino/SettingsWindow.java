...
import static co.com.leronarenwino.jukeboxcontroller.JukeboxController.loadData;
    ...
    public SettingsWindow() {
        ...
        saveButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selection == JOptionPane.YES_NO_OPTION) {
                    PropertiesManager.saveProperties(settingsToProperties());
                    loadSettings();
        ...
        defaultButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int selection = JOptionPane.showConfirmDialog(getContentPane(), "Are you sure?", "Warning", JOptionPane.OK_CANCEL_OPTION);
                if (selection == JOptionPane.YES_NO_OPTION) {
                    PropertiesManager.saveProperties(defaultSettingsProperties());
                    loadSettings();
